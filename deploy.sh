...
docker build --no-cache=false -t liuliio/armv7_api:v0.1.2 -f api.Dockerfile .
docker buildx build --no-cache=false --platform linux/arm/v7 -t liuliio/armv7_api:v0.1.2 -f api.Dockerfile .
# 运行
