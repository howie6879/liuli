...
直接在`.env`文件中增加相关[环境配置](./00.2C环境变量.md)即可：
...
对于分发器相关对象的密钥申请教程，详见[2C分发器配置](./02.2C分发器配置.md)。
...
[2021:12:23 16:16:02] INFO  2C Schedule started successfully :)
[2021:12:23 16:16:02] INFO  2C Schedule time:
 00:00
 06:00
 09:00
 12:00
